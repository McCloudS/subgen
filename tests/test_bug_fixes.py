...
4. SKIP_ONLY_SUBGEN_SUBTITLES=True still skipped based on embedded subtitle streams (#339)
"""
import sys
import os
import json
...
# ---------------------------------------------------------------------------
# Bug 4: SKIP_ONLY_SUBGEN_SUBTITLES=True still skipped on embedded streams (#339)
# ---------------------------------------------------------------------------
